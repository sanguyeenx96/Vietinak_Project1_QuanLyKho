...
{
    public partial class FormSuaInvoice : Form
    {
        public event EventHandler<DialogClosedEventArgs> DialogClosed;

        private int id;
        public FormSuaInvoice(int id)
        {
            InitializeComponent();
            this.id = id;
        }

        private void FormSuaInvoice_Load(object sender, EventArgs e)
        {
